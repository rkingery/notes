...
$$
\delta W = \sum_{i=1}^n J_i dq_i + \sum_{j=1}^m \mu_i dN_i.
$$
Of course, we still don't know how to simplify $\delta Q$ into a useful form. We'll deal with that soon. For simplicity, in the rest of this section we'll express things in vector notation by letting $J, dq, \mu, dN$ represent the vectorized forms of their component terms. Then we can just write the total work as just
$$
\delta W = J \cdot dq + \mu \cdot dN.
$$
...
$$
\boxed{dE = TdS + J \cdot dq + \mu \cdot dN} \ .
$$
...
$$
T = \frac{\partial E}{\partial S} \bigg |_q \ , \quad J_i = \frac{\partial E}{\partial q_i} \bigg |_{S, \ \{q_k: \ k \neq i\}, \ N} \ , \quad \mu_j = \frac{\partial E}{\partial q_i} \bigg |_{S, \ q, \ \{N_k: \ k \neq j\}} \ .
$$
---
...
$$
\boxed{SdT + q \cdot dJ + N \cdot d\mu = 0} \ .
$$
...
$$
\boxed{\delta T \delta S + \delta J \cdot \delta q + \delta \mu \cdot \delta N \geq 0} \ .
$$
