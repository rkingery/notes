...
1. An **adiabatic** system: A system isolated by "walls" that don't allow heat to flow in or out.
2. A **diathermic** system: A system with "permeable walls", where heat is allowed to flow in or out.
