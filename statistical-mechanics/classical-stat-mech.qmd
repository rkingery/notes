...
$$
This means all cumulants of $N$ will be $\log Z(\beta,\mu)$ as well. Recall all cumulants being equal implies that $N$ must be Poisson distributed. The grand potential is evidently just $\mathcal{G} = -\langle N \rangle k_B T$. But by extensivity $\mathcal{G} = -PV$. We thus get the ideal gas law,
$$
