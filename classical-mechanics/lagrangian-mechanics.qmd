...
$$
Then the Lagrangian for this system is given by
$$
L = T - U = \frac{1}{2} m \mathbf{v}^2 - q \phi(\mathbf{x},t) + \frac{q}{c} \mathbf{v} \cdot \mathbf{A}(\mathbf{x},t).
$$
...
![](./resources/image-20230301075040200.png){fig-align="center" width=250}
...
&= \bigg(\frac{1}{2} m \mathbf{v}^2 - q\phi + \frac{q}{c}\mathbf{v} \cdot \mathbf{A}\bigg) + \frac{q}{c} \bigg(\frac{\partial \lambda}{\partial t} + \mathbf{v} \cdot \nabla \lambda\bigg) \\
