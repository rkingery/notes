...
$$
In this case the idea is still the same. If we place an infinitesimal test charge $\delta q$ at a field point $\mathbf{x}$, the force it feels due to all of the *combined* source charges is $\mathbf{F} = \delta q\mathbf{E}$.
...
![](./resources/image-20240308152000873.png){fig-align=center width=300}

![image-20240308152108598](./resources/image-20240308152108598.png){fig-align=center width=300}

![](./resources/image-20240308152038464.png){fig-align=center width=300}

![](./resources/image-20240308152224236.png){fig-align=center width=300}
