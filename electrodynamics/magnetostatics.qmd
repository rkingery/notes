...
$$
Thus, if the charged particle has zero velocity in the $z$-direction, it will just orbit in a circle about the origin in the $xy$-plane, with the radius of that circle determined by the particle's initial radius from the origin. The speed at which the particle orbits is

- Still not finished. Mention the implications of circular motion, like $v = \omega / r$ and $E = 1/2 \ mv^2$

 determined by the cyclotron frequency $\omega = qB/mc$. Clearly, the stronger the B-field or the higher the particle's charge to mass ratio $q/m$, the faster it will orbit.

If the particle *does* have an initial velocity in the $z$-direction, it will maintain that velocity while still orbiting in a circle in the $xy$-plane. This will result in a helical motion, with the helix oriented in the direction of the B-field.

The example we described above is commonly used to accelerate charged particles with a device known as a *cyclotron*. The idea is to use a B-field to keep the particle confined to a circular path, while applying a varying E-field in the normal direction to force the particle to accelerate outward in a spiral motion. This technique was used in the early days of nuclear physics to build particle accelerators, which could be used to collide particles together at high energies and study their nuclear properties.
